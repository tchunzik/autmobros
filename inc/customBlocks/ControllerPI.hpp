#ifndef CONTROLLERPI_HPP_
#define CONTROLLERPI_HPP_
...
class ControllerPI : public Block
{
public:
    /**
     ...
     */
    ControllerPI(double om0, double D, double M, T eLimit)
        : qd(this),
          KP(2.0 * D * om0),
          KI(om0 * om0),
          M(M)
     ...
     * @param eLimit integrator limit
     */
    ControllerPI(double fTask, double D, double s, double M, T eLimit)
        : qd(this),
          KP(fTask / s),
...
private:
    ...
    {
        // Name all blocks
        ed.setName("controllerpi->ed");
        KP.setName("controllerpi->KP");
        e.setName("controllerpi->e");
        KI.setName("controllerpi->KI");
        qddC.setName("controllerpi->qddC");
        M.setName("controllerpi->M");
