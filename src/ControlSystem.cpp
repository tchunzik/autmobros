...
ControlSystem::ControlSystem(double dt)
    : E1("enc1"),
      ...
      invKin(0.15),
      g(21.2 / 2.0 / M_PI),
      controllerpi(1 / dt, 0.7, 2.3, 3441.0 / 104.0 / 0.04 * 3441.0 / 104.0 / 0.04 * 6.8e-8, 0.1),
      ...
      timedomain("Main time domain", dt, true)
{
    ...
    E1d.setName("E1d");
    g.setName("g");
    controllerpi.setName("controllerpi");
    ...
    controllerpi.getIn(0).connect(g.getOut());
    controllerpi.getIn(1).connect(E1d.getOut());
    invMotMod.getIn(0).connect(controllerpi.getOut(0));
    invMotMod.getIn(1).connect(controllerpi.getOut(1));
    ...
    timedomain.addBlock(controllerpi);
